...
def compare_pose(image, angle_point, angle_user, angle_target):
    ...
    if angle_user[0] < (angle_target[0] - 15):
        ...
        cv2.putText(
            image,
            str("Extend the right arm at elbow"),
            (10, 60),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.7,
            [0, 153, 0],
        ...
        cv2.circle(
            image,
            (int(angle_point[0][0] * width), int(angle_point[0][1] * height)),
            30,
            (0, 0, 255),
            5,
        )
    ...
    if angle_user[0] > (angle_target[0] + 15):
        ...
        cv2.putText(
            image,
            str("Fold the right arm at elbow"),
            (10, 80),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.7,
            [0, 153, 0],
    ...
    if angle_user[1] < (angle_target[1] - 15):
        ...
        cv2.putText(
            image,
            str("Extend the left arm at elbow"),
            (10, 100),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.7,
            [0, 153, 0],
        ...
        cv2.circle(
            image,
            (int(angle_point[1][0] * width), int(angle_point[1][1] * height)),
            30,
            (0, 0, 255),
            5,
        )
    ...
    if angle_user[1] > (angle_target[1] + 15):
        ...
        cv2.putText(
            image,
            str("Fold the left arm at elbow"),
            (10, 120),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.7,
            [0, 153, 0],
    ...
    if angle_user[2] < (angle_target[2] - 15):
        ...
        cv2.circle(
            image,
            (int(angle_point[2][0] * width), int(angle_point[2][1] * height)),
            30,
            (0, 0, 255),
            5,
        )
    ...
    if angle_user[2] > (angle_target[2] + 15):
        ...
        cv2.putText(
            image,
            str("Put your arm down a little"),
            (10, 160),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.7,
            [0, 153, 0],
    ...
    if angle_user[3] < (angle_target[3] - 15):
        ...
        cv2.circle(
            image,
            (int(angle_point[3][0] * width), int(angle_point[3][1] * height)),
            30,
            (0, 0, 255),
            5,
        )
    ...
    if angle_user[4] < (angle_target[4] - 15):
        ...
        cv2.putText(
            image,
            str("Extend the angle at right hip"),
            (10, 220),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.7,
            [0, 153, 0],
        ...
        cv2.circle(
            image,
            (int(angle_point[4][0] * width), int(angle_point[4][1] * height)),
            30,
            (0, 0, 255),
            5,
        )
    ...
    if angle_user[4] > (angle_target[4] + 15):
        ...
        cv2.putText(
            image,
            str("Reduce the angle of at right hip"),
            (10, 240),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.7,
            [0, 153, 0],
    ...
    if angle_user[5] < (angle_target[5] - 15):
        ...
        cv2.putText(
            image,
            str("Extend the angle at left hip"),
            (10, 260),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.7,
            [0, 153, 0],
        ...
        cv2.circle(
            image,
            (int(angle_point[5][0] * width), int(angle_point[5][1] * height)),
            30,
            (0, 0, 255),
            5,
        )
    ...
    if angle_user[5] > (angle_target[5] + 15):
        ...
        cv2.putText(
            image,
            str("Reduce the angle at left hip"),
            (10, 280),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.7,
            [0, 153, 0],
    ...
    if angle_user[6] < (angle_target[6] - 15):
        ...
        cv2.putText(
            image,
            str("Extend the angle of right knee"),
            (10, 300),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.7,
            [0, 153, 0],
        ...
        cv2.circle(
            image,
            (int(angle_point[6][0] * width), int(angle_point[6][1] * height)),
            30,
            (0, 0, 255),
            5,
        )
    ...
    if angle_user[6] > (angle_target[6] + 15):
        ...
        cv2.putText(
            image,
            str("Reduce the angle at right knee"),
            (10, 320),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.7,
            [0, 153, 0],
    ...
    if angle_user[7] < (angle_target[7] - 15):
        ...
        cv2.putText(
            image,
            str("Extend the angle at left knee"),
            (10, 340),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.7,
            [0, 153, 0],
        ...
        cv2.circle(
            image,
            (int(angle_point[7][0] * width), int(angle_point[7][1] * height)),
            30,
            (0, 0, 255),
            5,
        )
    ...
    if angle_user[7] > (angle_target[7] + 15):
        ...
        cv2.putText(
            image,
            str("Reduce the angle at left knee"),
            (10, 360),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.7,
            [0, 153, 0],
    ...
    while cap.isOpened():
        ...
        try:
            ...
            elbow = [
                ...
                round(
                    landmarks[mp_pose.PoseLandmark.LEFT_ELBOW.value].visibility * 100, 2
                ),
            ]
            wrist = [
                landmarks[mp_pose.PoseLandmark.LEFT_WRIST.value].x,
                ...
                round(
                    landmarks[mp_pose.PoseLandmark.LEFT_WRIST.value].visibility * 100, 2
                ),
            ]
