...
app.post('/api/mediapipe/yog1', (req, res) => {
  const pythonProcess = spawn('python', ["zaid.py"]);
...
app.post('/api/mediapipe/yog2', (req, res) => {
  const pythonProcess = spawn('python', ["zaidyog2.py"]);
...
app.post('/api/mediapipe/yog3', (req, res) => {
  const pythonProcess = spawn('python', ["zaidyog4.py"]);
...
app.post('/api/mediapipe/yog5', (req, res) => {
  const pythonProcess = spawn('python', ["zaidyog3.py"]);
...
app.get('/get/mediapipe/yog10', (req, res) => {
  res.send("helo world!!s")
});
